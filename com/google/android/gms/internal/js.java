...
public interface js extends IInterface {
   void b(int var1, IBinder var2, Bundle var3) throws RemoteException;

   public abstract static class a extends Binder implements js {
      public a() {
         this.attachInterface(this, "com.google.android.gms.common.internal.IGmsCallbacks");
      }

      public static js P(IBinder var0) {
         if(var0 == null) {
            return null;
         } else {
            IInterface var1 = var0.queryLocalInterface("com.google.android.gms.common.internal.IGmsCallbacks");
            return (js)(var1 != null && var1 instanceof js?(js)var1:new js.a(var0));
         }
      }
   ...
   private static class a implements js {
      private IBinder le;
      ...
      public void b(int param1, IBinder param2, Bundle param3) throws RemoteException {
