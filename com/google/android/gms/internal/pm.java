...
public class pm implements Creator {
   static void a(pi.a var0, Parcel var1, int var2) {
      ...
      if(var3.contains(Integer.valueOf(2))) {
         com.google.android.gms.common.internal.safeparcel.b.c(var1, 2, var0.apJ);
      }

      if(var3.contains(Integer.valueOf(3))) {
         com.google.android.gms.common.internal.safeparcel.b.c(var1, 3, var0.apK);
      }
