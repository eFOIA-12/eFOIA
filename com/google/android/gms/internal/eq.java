...
public interface eq extends IInterface {
   ...
   public abstract static class a extends Binder implements eq {
      ...
      public boolean onTransact(int var1, Parcel var2, Parcel var3, int var4) throws RemoteException {
         ...
         case 3:
            var2.enforceInterface("com.google.android.gms.ads.internal.purchase.client.IInAppPurchaseResult");
            var1 = this.getResultCode();
            var3.writeNoException();
            var3.writeInt(var1);
            return true;
         case 4:
            var2.enforceInterface("com.google.android.gms.ads.internal.purchase.client.IInAppPurchaseResult");
            boolean var6 = this.isVerified();
            var3.writeNoException();
            byte var7 = var5;
            if(var6) {
               var7 = 1;
   ...
   private static class a implements eq {
      private IBinder le;
      ...
      public Intent getPurchaseData() throws RemoteException {
         ...
         label36: {
            try {
               var5 = true;
               var2.writeInterfaceToken("com.google.android.gms.ads.internal.purchase.client.IInAppPurchaseResult");
      ...
      public boolean isVerified() throws RemoteException {
         ...
         try {
            var7 = true;
            var3.writeInterfaceToken("com.google.android.gms.ads.internal.purchase.client.IInAppPurchaseResult");
