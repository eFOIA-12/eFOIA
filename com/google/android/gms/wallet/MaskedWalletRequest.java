...
public final class MaskedWalletRequest implements SafeParcelable {
   ...
   MaskedWalletRequest(int var1, String var2, boolean var3, boolean var4, boolean var5, String var6, String var7, String var8, Cart var9, boolean var10, boolean var11, CountrySpecification[] var12, boolean var13, boolean var14, ArrayList var15) {
      this.CK = var1;
      this.auM = var2;
      this.avz = var3;
      this.avA = var4;
   ...
   public final class Builder {
      ...
      public MaskedWalletRequest.Builder addAllowedCountrySpecificationsForShipping(Collection var1) {
         if(var1 != null) {
            if(MaskedWalletRequest.this.avJ == null) {
               MaskedWalletRequest.this.avJ = new ArrayList();
            }
