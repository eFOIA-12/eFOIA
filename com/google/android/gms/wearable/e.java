...
public class e implements Creator {
   static void a(PutDataRequest var0, Parcel var1, int var2) {
   ...
   public PutDataRequest en(Parcel var1) {
      byte[] var5 = null;
      ...
      if(var1.dataPosition() != var3) {
         ...
         return new PutDataRequest(var2, var6, var7, var5);
      }
   }

   public PutDataRequest[] gw(int var1) {
