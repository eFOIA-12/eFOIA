...
public class n implements Creator {
   static void a(DeleteResourceRequest var0, Parcel var1, int var2) {
   ...
   public DeleteResourceRequest aj(Parcel var1) {
      ...
      if(var1.dataPosition() != var3) {
         ...
         return new DeleteResourceRequest(var2, var5);
      }
   }

   public DeleteResourceRequest[] bu(int var1) {
