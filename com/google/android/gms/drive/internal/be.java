...
public class be implements Creator {
   static void a(SetFileUploadPreferencesRequest var0, Parcel var1, int var2) {
   ...
   public SetFileUploadPreferencesRequest aI(Parcel var1) {
      ...
      if(var1.dataPosition() != var3) {
         ...
         return new SetFileUploadPreferencesRequest(var2, var5);
      }
   }

   public SetFileUploadPreferencesRequest[] bX(int var1) {
      return new SetFileUploadPreferencesRequest[var1];
   }
