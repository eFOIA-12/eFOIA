...
public class a implements Creator {
   static void a(AddEventListenerRequest var0, Parcel var1, int var2) {
   ...
   public AddEventListenerRequest Z(Parcel var1) {
      int var2 = 0;
      ...
      if(var1.dataPosition() != var4) {
         ...
         return new AddEventListenerRequest(var3, var6, var2);
      }
   }

   public AddEventListenerRequest[] bj(int var1) {
