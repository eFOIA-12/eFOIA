...
public class e implements Creator {
   static void a(CheckResourceIdsExistRequest var0, Parcel var1, int var2) {
   ...
   public CheckResourceIdsExistRequest ac(Parcel var1) {
      ...
      if(var1.dataPosition() != var3) {
         ...
         return new CheckResourceIdsExistRequest(var2, var5);
      }
   }

   public CheckResourceIdsExistRequest[] bm(int var1) {
