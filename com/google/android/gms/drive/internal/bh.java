...
public class bh implements Creator {
   static void a(TrashResourceRequest var0, Parcel var1, int var2) {
   ...
   public TrashResourceRequest aK(Parcel var1) {
      ...
      if(var1.dataPosition() != var3) {
         ...
         return new TrashResourceRequest(var2, var5);
      }
   }

   public TrashResourceRequest[] bZ(int var1) {
