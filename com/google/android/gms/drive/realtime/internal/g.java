...
public interface g extends IInterface {
   void a(DataHolder var1, ParcelableEventList var2) throws RemoteException;

   void n(Status var1) throws RemoteException;

   public abstract static class a extends Binder implements g {
      public static g af(IBinder var0) {
         if(var0 == null) {
            return null;
         } else {
      ...
      public boolean onTransact(int var1, Parcel var2, Parcel var3, int var4) throws RemoteException {
         ...
         case 1:
            ...
            ParcelableEventList var6;
            if(var2.readInt() != 0) {
               var6 = (ParcelableEventList)ParcelableEventList.CREATOR.createFromParcel(var2);
            } else {
               var6 = null;
            }
   ...
   private static class a implements g {
      ...
      public void a(DataHolder param1, ParcelableEventList param2) throws RemoteException {
