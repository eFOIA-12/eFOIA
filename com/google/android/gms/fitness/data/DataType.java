...
public final class DataType implements SafeParcelable {
   ...
   static {
      ...
      Uq = new DataType("com.google.activity.edge", new Field[]{Field.FIELD_ACTIVITY, Field.UA});
      Ur = new DataType("com.google.accelerometer", new Field[]{Field.UB, Field.UC, Field.UD});
      ...
      Us = new HashMap() {
         {
            this.put(DataType.TYPE_ACTIVITY_SEGMENT, Arrays.asList(new DataType[]{DataType.AGGREGATE_ACTIVITY_SUMMARY}));
            this.put(DataType.TYPE_DISTANCE_DELTA, Arrays.asList(new DataType[]{DataType.AGGREGATE_DISTANCE_DELTA}));
            this.put(DataType.TYPE_LOCATION_SAMPLE, Arrays.asList(new DataType[]{DataType.AGGREGATE_LOCATION_BOUNDING_BOX}));
            this.put(DataType.TYPE_POWER_SAMPLE, Arrays.asList(new DataType[]{DataType.AGGREGATE_POWER_SUMMARY}));
            this.put(DataType.TYPE_HEART_RATE_BPM, Arrays.asList(new DataType[]{DataType.AGGREGATE_HEART_RATE_SUMMARY}));
            this.put(DataType.TYPE_SPEED, Arrays.asList(new DataType[]{DataType.AGGREGATE_SPEED_SUMMARY}));
            this.put(DataType.TYPE_STEP_COUNT_DELTA, Arrays.asList(new DataType[]{DataType.AGGREGATE_STEP_COUNT_DELTA}));
            this.put(DataType.TYPE_WEIGHT, Arrays.asList(new DataType[]{DataType.AGGREGATE_WEIGHT_SUMMARY}));
         }
      };
   ...
   public DataType(String var1, Field... var2) {
      this(1, var1, la.b(var2));
   }

   private boolean a(DataType var1) {
      return this.mName.equals(var1.mName) && this.Uv.equals(var1.Uv);
   }

   public static List getAggregatesForInput(DataType var0) {
      List var1 = (List)Us.get(var0);
   ...
   public boolean equals(Object var1) {
      return this == var1 || var1 instanceof DataType && this.a((DataType)var1);
   }
