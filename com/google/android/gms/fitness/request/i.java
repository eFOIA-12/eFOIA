...
public class i implements Creator {
   static void a(DataTypeCreateRequest var0, Parcel var1, int var2) {
   ...
   public DataTypeCreateRequest bN(Parcel var1) {
      ArrayList var6 = null;
      ...
      if(var1.dataPosition() != var3) {
         ...
         return new DataTypeCreateRequest(var2, var5, var6);
      }
   }
   ...
   public DataTypeCreateRequest[] dh(int var1) {
