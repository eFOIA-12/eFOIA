...
public abstract class RoomConfig {
   public static RoomConfig.Builder builder(RoomUpdateListener var0) {
      return new RoomConfig.Builder(var0, null);
   }
   ...
   public static final class Builder {
      ...
      private Builder(RoomUpdateListener var1) {
         ...
         this.aen = false;
         this.aeh = (RoomUpdateListener)jx.b((Object)var1, "Must provide a RoomUpdateListener");
      }
      ...
      public RoomConfig.Builder addPlayersToInvite(ArrayList var1) {
         jx.i(var1);
      ...
      public RoomConfig.Builder setVariant(int var1) {
         ...
         jx.b(var2, "Variant must be a positive integer or Room.ROOM_VARIANT_ANY");
         this.adW = var1;
         return this;
      }
   }
