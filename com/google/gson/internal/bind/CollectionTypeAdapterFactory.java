...
public final class CollectionTypeAdapterFactory implements TypeAdapterFactory {
   ...
   public TypeAdapter create(Gson var1, TypeToken var2) {
      ...
      if(!Collection.class.isAssignableFrom(var4)) {
         ...
         var3 = $Gson$Types.getCollectionElementType(var3, var4);
         return new CollectionTypeAdapterFactory.Adapter(var1, var3, var1.getAdapter(TypeToken.get(var3)), this.constructorConstructor.get(var2));
      }
   }
