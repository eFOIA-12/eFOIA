...
public class SignOutTask extends CaptiveReachRequest {
   public SignOutTask(Context var1, String var2, TaskListener var3) {
      super(var1, "DELETE", var2, var3);
   }

   protected String getRequestUrl() throws Exception {
      return SettingsUtils.getBaseRestUrl(this.context) + "mobile_users/sign_out";
   }
