...
@Deprecated
public class PostTrackingEventTask extends CaptiveReachRequest {
   private Tracker report;
   private CRSendContentDao send;

   public PostTrackingEventTask(Context var1, Tracker var2) {
   ...
   private String getJson() {
      ...
      Log.v(PostTrackingEventTask.class.getSimpleName(), var2);
      return var2;
   }
   ...
   protected String getRequestUrl() throws Exception {
      return SettingsUtils.getBaseRestUrl(this.context) + "insights/track";
   }
