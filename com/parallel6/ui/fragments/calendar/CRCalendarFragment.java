...
public class CRCalendarFragment extends BaseFragment {
   private static boolean isUpdated;
   private int SELECTED_TAB_COLOR;
   private int UNSELECTED_TAB_COLOR;
   private CRCalendarFragment.MyCalendarTab activeTab;
   ...
   private OnClickListener onClickListener = new OnClickListener() {
      public void onClick(View var1) {
         if(var1 == CRCalendarFragment.this.calendarBtn) {
            CRCalendarFragment.this.activeTab = CRCalendarFragment.MyCalendarTab.Calendar;
         } else if(var1 == CRCalendarFragment.this.listBtn) {
            CRCalendarFragment.this.activeTab = CRCalendarFragment.MyCalendarTab.List;
         }

         CRCalendarFragment.this.showActiveTab();
      }
   };
   ...
   private void setButtons(CRCalendarFragment.MyCalendarTab var1) {
      if(var1 == CRCalendarFragment.MyCalendarTab.Calendar) {
         this.calendarBtn.setBackgroundColor(this.UNSELECTED_TAB_COLOR);
         this.listBtn.setBackgroundColor(this.SELECTED_TAB_COLOR);
      } else if(var1 == CRCalendarFragment.MyCalendarTab.List) {
   ...
   protected View getFragmentActionBarView(Context var1) {
      ...
      var3.setText(var4);
      ImageView var5;
      if(this.activeTab == CRCalendarFragment.MyCalendarTab.Calendar) {
         ...
         var5.setOnClickListener(new OnClickListener() {
            public void onClick(View var1) {
               long var2 = CRCalendarFragment.this.currentSelectedDate.getTime();
               if(var2 > 0L) {
                  CRCalendarFragment.this.controller.handleMessage(new CRMessage(-1412628463, new Object[]{Long.valueOf(CRCalendarFragment.this.minDate.getTime()), Long.valueOf(CRCalendarFragment.this.maxDate.getTime()), Long.valueOf(var2)}));
               } else {
                  CRCalendarFragment.this.controller.handleMessage(new CRMessage(-1412628463, new Object[]{Long.valueOf(CRCalendarFragment.this.minDate.getTime()), Long.valueOf(CRCalendarFragment.this.maxDate.getTime())}));
               }
            }
         });
      }
      ...
      var5.setOnClickListener(new OnClickListener() {
         public void onClick(View var1) {
            CRCalendarFragment.this.controller.handleMessage(-1412628478);
         }
      });
      return var2;
   }
   ...
   public void onCreate(Bundle var1) {
      super.onCreate(var1);
      this.activeTab = CRCalendarFragment.MyCalendarTab.Calendar;
   ...
   public void selectedDateListTab(long var1) {
      ...
      this.activeTab = CRCalendarFragment.MyCalendarTab.List;
      this.calendarBtn.setBackgroundColor(this.SELECTED_TAB_COLOR);
      this.listBtn.setBackgroundColor(this.UNSELECTED_TAB_COLOR);
   ...
   public void showActiveTab() {
      ...
      switch(null.$SwitchMap$com$parallel6$ui$fragments$calendar$CRCalendarFragment$MyCalendarTab[this.activeTab.ordinal()]) {
      case 1:
         ...
         if(this.calendarTab == null) {
            ...
            this.calendarTab.initTab(this, this.dates, this.currentSelectedDate, this.minDate, this.maxDate, (CRConfLayoutModule)null);
         } else {
