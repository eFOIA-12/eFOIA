...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflaterFactory {
      ...
      if(var1.mState < var2) {
         ...
         case 0:
            ...
            if(var1.mSavedFragmentState != null) {
               var1.mSavedFragmentState.setClassLoader(this.mActivity.getClassLoader());
   ...
   public View onCreateView(View var1, String var2, Context var3, AttributeSet var4) {
      if("fragment".equals(var2)) {
         ...
         var10.recycle();
         if(Fragment.isSupportFragmentClass(this.mActivity, var8)) {
            int var5;
            if(var1 != null) {
               var5 = var1.getId();
            } else {
            ...
            if(var12 == null) {
               ...
               var11.onInflate(this.mActivity, var4, var11.mSavedFragmentState);
               ...
               var11 = var12;
               if(!var12.mRetaining) {
                  var12.onInflate(this.mActivity, var4, var12.mSavedFragmentState);
                  var11 = var12;
               }
            }
