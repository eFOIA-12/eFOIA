         ...
         if(!var2.equals(this.mCachedEnabledPackages)) {
            ...
            while(var6.hasNext()) {
               ...
               if(!this.mRecordMap.containsKey(var8)) {
                  ...
                  this.mRecordMap.put(var8, new NotificationManagerCompat.ListenerRecord(var8));
               }
            }
            ...
            while(var6.hasNext()) {
               ...
               if(!var1.contains(var9.getKey())) {
                  ...
                  this.ensureServiceUnbound((NotificationManagerCompat.ListenerRecord)var9.getValue());
                  var6.remove();
               }
            }
         }
