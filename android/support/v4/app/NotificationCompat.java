...
public class NotificationCompat {
   ...
   private static void addActionsToBuilder(NotificationBuilderWithActions var0, ArrayList var1) {
   ...
   public static class Action extends NotificationCompatBase.Action {
      public static final NotificationCompatBase.Factory FACTORY = new NotificationCompatBase.Factory() {
         public NotificationCompat.Action build(int var1, CharSequence var2, PendingIntent var3, Bundle var4, RemoteInputCompatBase.RemoteInput[] var5) {
            return new NotificationCompat.Action(var1, var2, var3, var4, (RemoteInput[])((RemoteInput[])var5), null);
         }
   ...
   public static final class Builder {
      ...
      public NotificationCompat.Action build() {
         ...
         return new NotificationCompat.Action(this.mIcon, this.mTitle, this.mIntent, this.mExtras, var1, null);
      }
   ...
   public static class Builder {
      ...
      public NotificationCompat.UnreadConversation build() {
         ...
         return new NotificationCompat.UnreadConversation(var3, var5, var6, var7, new String[]{var4}, var1);
      }
