...
public abstract class NotificationCompatSideChannelService extends Service {
   ...
   public IBinder onBind(Intent var1) {
      return var1.getAction().equals("android.support.BIND_NOTIFICATION_SIDE_CHANNEL") && VERSION.SDK_INT <= 19?new NotificationCompatSideChannelService.NotificationSideChannelStub(null):null;
   }
