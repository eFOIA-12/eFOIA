...
class ViewCompatLollipop {
   public static WindowInsetsCompat dispatchApplyWindowInsets(View var0, WindowInsetsCompat var1) {
      ...
      if(var1 instanceof WindowInsetsCompatApi21) {
         WindowInsets var3 = ((WindowInsetsCompatApi21)var1).unwrap();
         WindowInsets var4 = var0.dispatchApplyWindowInsets(var3);
         var2 = var1;
         if(var4 != var3) {
            var2 = new WindowInsetsCompatApi21(var4);
         }
      }

      return (WindowInsetsCompat)var2;
   }
   ...
   public static WindowInsetsCompat onApplyWindowInsets(View var0, WindowInsetsCompat var1) {
      ...
      if(var1 instanceof WindowInsetsCompatApi21) {
         WindowInsets var3 = ((WindowInsetsCompatApi21)var1).unwrap();
         WindowInsets var4 = var0.onApplyWindowInsets(var3);
         var2 = var1;
         if(var4 != var3) {
            var2 = new WindowInsetsCompatApi21(var4);
         }
