...
public class AccessibilityNodeInfoCompat {
   ...
   public List getActionList() {
      ...
      if(var5 != null) {
         ...
         while(true) {
            ...
            var4.add(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(var5.get(var1), null));
            ++var1;
         }
      } else {
   ...
   public AccessibilityNodeInfoCompat.CollectionInfoCompat getCollectionInfo() {
      ...
      return var1 == null?null:new AccessibilityNodeInfoCompat.CollectionInfoCompat(var1, null);
   }
   ...
   public AccessibilityNodeInfoCompat.CollectionItemInfoCompat getCollectionItemInfo() {
      ...
      return var1 == null?null:new AccessibilityNodeInfoCompat.CollectionItemInfoCompat(var1, null);
   }
   ...
   public AccessibilityNodeInfoCompat.RangeInfoCompat getRangeInfo() {
      ...
      return var1 == null?null:new AccessibilityNodeInfoCompat.RangeInfoCompat(var1, null);
   }
