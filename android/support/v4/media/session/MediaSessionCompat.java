...
public class MediaSessionCompat {
   ...
   public MediaSessionCompat(Context var1, String var2, ComponentName var3, PendingIntent var4) {
      if(var1 == null) {
         ...
         if(VERSION.SDK_INT >= 21) {
            ...
            this.mImpl.setMediaButtonReceiver(var4);
         } else {
            this.mImpl = new MediaSessionCompat.MediaSessionImplBase(var1, var2, var3, var4);
         }
   ...
   public abstract static class Callback {
      ...
      public Callback() {
         if(VERSION.SDK_INT >= 21) {
            this.mCallbackObj = MediaSessionCompatApi21.createCallback(new MediaSessionCompat.StubApi21(null));
         } else {
   ...
   static class MediaSessionImplBase implements MediaSessionCompat.MediaSessionImpl {
      ...
      public MediaSessionImplBase(Context var1, String var2, ComponentName var3, PendingIntent var4) {
         if(var3 == null) {
            ...
            this.mMediaButtonEventReceiver = var5;
            ...
            if(VERSION.SDK_INT >= 14) {
               this.mRccObj = MediaSessionCompatApi14.createRemoteControlClient(var5);
            } else {
               this.mRccObj = null;
            }
         }
      ...
      public void handleMessage(Message var1) {
         if(MediaSessionCompat.super.mCallback != null) {
            ...
            case 13:
               ...
               return;
            case 14:
               MediaSessionCompat.super.mCallback.onMediaButtonEvent((Intent)var1.obj);
               return;
            case 15:
               MediaSessionCompat.Command var2 = (MediaSessionCompat.Command)var1.obj;
               MediaSessionCompat.super.mCallback.onCommand(var2.command, var2.extras, var2.stub);
               return;
            case 16:
   ...
   public static final class QueueItem implements Parcelable {
      public static final Creator CREATOR = new Creator() {
         public MediaSessionCompat.QueueItem createFromParcel(Parcel var1) {
            return new MediaSessionCompat.QueueItem(var1, null);
         }
