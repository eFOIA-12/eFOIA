...
public final class MediaControllerCompat {
   ...
   public abstract static class Callback implements DeathRecipient {
      ...
      public Callback() {
         if(VERSION.SDK_INT >= 21) {
            this.mCallbackObj = MediaControllerCompatApi21.createCallback(new MediaControllerCompat.StubApi21(null));
         } else {
            this.mCallbackObj = new MediaControllerCompat.StubCompat(null);
         }
      }
