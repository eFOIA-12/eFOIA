...
public class MediaSessionCompatApi19 {
   ...
   public static Object createMetadataUpdateListener(MediaSessionCompatApi14.Callback var0) {
   ...
   static class OnMetadataUpdateListener implements android.media.RemoteControlClient.OnMetadataUpdateListener {
      ...
      public OnMetadataUpdateListener(MediaSessionCompatApi14.Callback var1) {
         this.mCallback = var1;
      }
