...
public class ContextCompat {
   ...
   public final File getCodeCacheDir(Context var1) {
      return VERSION.SDK_INT >= 21?ContextCompatApi21.getCodeCacheDir(var1):createFilesDir(new File(var1.getApplicationInfo().dataDir, "code_cache"));
   }
