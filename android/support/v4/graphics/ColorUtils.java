...
public class ColorUtils {
   ...
   public static int HSLToColor(float[] var0) {
      ...
      return Color.rgb(Math.max(0, Math.min(255, var7)), Math.max(0, Math.min(255, var6)), Math.max(0, Math.min(255, var5)));
   }

   public static void RGBToHSL(int var0, int var1, int var2, float[] var3) {
      float var4 = (float)var0 / 255.0F;
      float var7 = (float)var1 / 255.0F;
      float var8 = (float)var2 / 255.0F;
      float var9 = Math.max(var4, Math.max(var7, var8));
      float var10 = Math.min(var4, Math.min(var7, var8));
      float var5 = var9 - var10;
      float var6 = (var9 + var10) / 2.0F;
      if(var9 == var10) {
         var5 = 0.0F;
         var4 = 0.0F;
      } else {
         ...
         var5 /= 1.0F - Math.abs(2.0F * var6 - 1.0F);
      }

      var3[0] = 60.0F * var4 % 360.0F;
      var3[1] = var5;
      var3[2] = var6;
   }
