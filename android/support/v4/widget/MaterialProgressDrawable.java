...
class MaterialProgressDrawable extends Drawable implements Animatable {
   ...
   private static final Interpolator END_CURVE_INTERPOLATOR = new MaterialProgressDrawable.EndCurveInterpolator(null);
   static final int LARGE = 0;
   private static final Interpolator LINEAR_INTERPOLATOR = new LinearInterpolator();
   private static final float MAX_PROGRESS_ARC = 0.8F;
   private static final float NUM_POINTS = 5.0F;
   private static final Interpolator START_CURVE_INTERPOLATOR = new MaterialProgressDrawable.StartCurveInterpolator(null);
   ...
   private void applyFinishTranslation(float var1, MaterialProgressDrawable.Ring var2) {
      ...
      var2.setStartTrim(var2.getStartingStartTrim() + (var2.getStartingEndTrim() - var2.getStartingStartTrim()) * var1);
      ...
      Animation var2 = new Animation() {
         public void applyTransformation(float var1x, Transformation var2) {
            if(MaterialProgressDrawable.this.mFinishing) {
               ...
               float var5 = (float)Math.toRadians((double)var1.getStrokeWidth() / (6.283185307179586D * var1.getCenterRadius()));
               float var6 = var1.getStartingEndTrim();
               float var3 = var1.getStartingStartTrim();
               float var4 = var1.getStartingRotation();
               float var7 = MaterialProgressDrawable.START_CURVE_INTERPOLATOR.getInterpolation(var1x);
               var1.setEndTrim(var6 + var7 * (0.8F - var5));
               var5 = MaterialProgressDrawable.END_CURVE_INTERPOLATOR.getInterpolation(var1x);
               var1.setStartTrim(var3 + 0.8F * var5);
               var1.setRotation(var4 + 0.25F * var1x);
               var3 = MaterialProgressDrawable.this.mRotationCount / 5.0F;
               MaterialProgressDrawable.this.setRotation(144.0F * var1x + 720.0F * var3);
            }
         }
      };
   ...
   private static class EndCurveInterpolator extends AccelerateDecelerateInterpolator {
      ...
      // $FF: synthetic method
      EndCurveInterpolator(Object var1) {
         this();
      }

      public float getInterpolation(float var1) {
         return super.getInterpolation(Math.max(0.0F, (var1 - 0.5F) * 2.0F));
      }
   }
   ...
   private static class StartCurveInterpolator extends AccelerateDecelerateInterpolator {
      ...
      // $FF: synthetic method
      StartCurveInterpolator(Object var1) {
         this();
      }

      public float getInterpolation(float var1) {
         return super.getInterpolation(Math.min(1.0F, 2.0F * var1));
      }
   }
}
