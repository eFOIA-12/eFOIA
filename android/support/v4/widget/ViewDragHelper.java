...
public class ViewDragHelper {
   ...
   private boolean checkNewEdgeDrag(float var1, float var2, int var3, int var4) {
      ...
      if((this.mInitialEdgesTouched[var3] & var4) == var4 && (this.mTrackingEdges & var4) != 0 && (this.mEdgeDragsLocked[var3] & var4) != var4 && (this.mEdgeDragsInProgress[var3] & var4) != var4 && (var1 > (float)this.mTouchSlop || var2 > (float)this.mTouchSlop)) {
         if(var1 < 0.5F * var2 && this.mCallback.onEdgeLock(var4)) {
   ...
   private int computeSettleDuration(View var1, int var2, int var3, int var4, int var5) {
      ...
      if(var4 != 0) {
         ...
         var6 = (float)var8 / (float)var13;
      }

      float var7;
      if(var5 != 0) {
         var7 = (float)var11 / (float)var12;
      } else {
         var7 = (float)var9 / (float)var13;
      }
   ...
   private void dragTo(int var1, int var2, int var3, int var4) {
      ...
      if(var3 != 0) {
         ...
         this.mCapturedView.offsetLeftAndRight(var6 - var7);
      }

      if(var4 != 0) {
         var5 = this.mCallback.clampViewPositionVertical(this.mCapturedView, var2, var4);
         this.mCapturedView.offsetTopAndBottom(var5 - var8);
      }
   ...
   public void processTouchEvent(MotionEvent var1) {
      ...
      case 0:
         ...
         View var12 = this.findTopChildUnder((int)var2, (int)var3);
      ...
      case 2:
         if(this.mDragState == 1) {
            ...
            var7 = (int)(var3 - this.mLastMotionY[this.mActivePointerId]);
         ...
         for(var6 = 0; var6 < var7; ++var6) {
            int var13 = MotionEventCompat.getPointerId(var1, var6);
            var2 = MotionEventCompat.getX(var1, var6);
            var3 = MotionEventCompat.getY(var1, var6);
            float var4 = var2 - this.mInitialMotionX[var13];
            float var5 = var3 - this.mInitialMotionY[var13];
            this.reportNewEdgeDrags(var4, var5, var13);
            if(this.mDragState == 1) {
               break;
            }

            View var11 = this.findTopChildUnder((int)var2, (int)var3);
            if(this.checkTouchSlop(var11, var4, var5) && this.tryCaptureViewForDrag(var11, var13)) {
               break;
            }
         }
      ...
      case 5:
         ...
         if(this.mDragState == 0) {
            this.tryCaptureViewForDrag(this.findTopChildUnder((int)var2, (int)var3), var7);
            ...
            this.tryCaptureViewForDrag(this.mCapturedView, var7);
            return;
         }
         break;
      case 6:
         int var9 = MotionEventCompat.getPointerId(var1, var6);
         if(this.mDragState == 1 && var9 == this.mActivePointerId) {
            byte var8 = -1;
            int var10 = MotionEventCompat.getPointerCount(var1);
            var6 = 0;
   ...
   public boolean shouldInterceptTouchEvent(MotionEvent var1) {
      ...
      case 0:
         ...
         var6 = MotionEventCompat.getPointerId(var1, 0);
         this.saveInitialMotion(var2, var3, var6);
         var17 = this.findTopChildUnder((int)var2, (int)var3);
         if(var17 == this.mCapturedView && this.mDragState == 2) {
            this.tryCaptureViewForDrag(var17, var6);
         }
      ...
      case 2:
         if(this.mInitialMotionX != null && this.mInitialMotionY != null) {
            int var8 = MotionEventCompat.getPointerCount(var1);

            for(var6 = 0; var6 < var8; ++var6) {
               int var9 = MotionEventCompat.getPointerId(var1, var6);
               var2 = MotionEventCompat.getX(var1, var6);
               var3 = MotionEventCompat.getY(var1, var6);
               float var4 = var2 - this.mInitialMotionX[var9];
               float var5 = var3 - this.mInitialMotionY[var9];
               View var16 = this.findTopChildUnder((int)var2, (int)var3);
               boolean var18;
               if(var16 != null && this.checkTouchSlop(var16, var4, var5)) {
                  var18 = true;
               } else {
                  var18 = false;
               }
               ...
               if(var18) {
                  int var10 = var16.getLeft();
                  int var11 = (int)var4;
                  var11 = this.mCallback.clampViewPositionHorizontal(var16, var10 + var11, (int)var4);
                  int var12 = var16.getTop();
                  int var13 = (int)var5;
                  var13 = this.mCallback.clampViewPositionVertical(var16, var12 + var13, (int)var5);
                  int var14 = this.mCallback.getViewHorizontalDragRange(var16);
                  int var15 = this.mCallback.getViewVerticalDragRange(var16);
                  if((var14 == 0 || var14 > 0 && var11 == var10) && (var15 == 0 || var15 > 0 && var13 == var12)) {
                     break;
                  }
               }

               this.reportNewEdgeDrags(var4, var5, var9);
               if(this.mDragState == 1 || var18 && this.tryCaptureViewForDrag(var16, var9)) {
                  break;
               }
            }
      ...
      case 5:
         ...
         if(this.mDragState == 0) {
            ...
            var17 = this.findTopChildUnder((int)var2, (int)var3);
            if(var17 == this.mCapturedView) {
               this.tryCaptureViewForDrag(var17, var7);
            }
         }
         break;
      case 6:
