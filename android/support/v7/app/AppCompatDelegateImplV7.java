...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase implements MenuBuilder.Callback, LayoutInflaterFactory {
   ...
   private void onKeyUpPanel(int var1, KeyEvent var2) {
   ...
   public View createView(View var1, String var2, @NonNull Context var3, @NonNull AttributeSet var4) {
      ...
      boolean var6;
      if(var5 && this.mSubDecorInstalled && var1 != null && var1.getId() != 16908290) {
         var6 = true;
      } else {
         var6 = false;
      }

      return this.mAppCompatViewInflater.createView(var1, var2, var3, var4, var6, var5);
   }
   ...
   void onTitleChanged(CharSequence var1) {
      if(this.mDecorContentParent != null) {
         ...
         if(this.getSupportActionBar() != null) {
            this.getSupportActionBar().setWindowTitle(var1);
            return;
         }
   ...
   public void setSupportActionBar(Toolbar var1) {
      if(this.mOriginalWindowCallback instanceof Activity) {
         if(this.getSupportActionBar() instanceof WindowDecorActionBar) {
            ...
            ToolbarActionBar var2 = new ToolbarActionBar(var1, ((Activity)this.mContext).getTitle(), this.mWindow);
   ...
   public ActionMode startSupportActionMode(ActionMode.Callback var1) {
      if(var1 == null) {
         ...
         AppCompatDelegateImplV7.ActionModeCallbackWrapper var3 = new AppCompatDelegateImplV7.ActionModeCallbackWrapper(var1);
         ActionBar var2 = this.getSupportActionBar();
         if(var2 != null) {
   ...
   ActionMode startSupportActionModeFromWindow(ActionMode.Callback var1) {
      ...
      AppCompatDelegateImplV7.ActionModeCallbackWrapper var5 = new AppCompatDelegateImplV7.ActionModeCallbackWrapper(var1);
      if(this.mActionModeView == null) {
         if(this.mIsFloating) {
            TypedValue var6 = new TypedValue();
            Theme var4 = this.mContext.getTheme();
            var4.resolveAttribute(R.attr.actionBarTheme, var6, true);
            Object var8;
            if(var6.resourceId != 0) {
               Theme var7 = this.mContext.getResources().newTheme();
               var7.setTo(var4);
               var7.applyStyle(var6.resourceId, true);
               var8 = new ContextThemeWrapper(this.mContext, 0);
               ((Context)var8).getTheme().setTo(var7);
            } else {
               var8 = this.mContext;
            }

            this.mActionModeView = new ActionBarContextView((Context)var8);
            this.mActionModePopup = new PopupWindow((Context)var8, (AttributeSet)null, R.attr.actionModePopupWindowStyle);
            this.mActionModePopup.setContentView(this.mActionModeView);
            this.mActionModePopup.setWidth(-1);
            ((Context)var8).getTheme().resolveAttribute(R.attr.actionBarSize, var6, true);
            int var2 = TypedValue.complexToDimensionPixelSize(var6.data, ((Context)var8).getResources().getDisplayMetrics());
            ...
            ViewStubCompat var9 = (ViewStubCompat)this.mSubDecor.findViewById(R.id.action_mode_bar_stub);
            if(var9 != null) {
               var9.setLayoutInflater(LayoutInflater.from(this.getActionBarThemedContext()));
               this.mActionModeView = (ActionBarContextView)var9.inflate();
            }
         }
      }
      ...
      if(this.mActionModeView != null) {
         ...
         Context var10 = this.mActionModeView.getContext();
         ...
         StandaloneActionMode var11 = new StandaloneActionMode(var10, var12, var5, var3);
         if(var1.onCreateActionMode(var11, var11.getMenu())) {
            var11.invalidate();
            this.mActionModeView.initForMode(var11);
            this.mActionModeView.setVisibility(0);
            this.mActionMode = var11;
            if(this.mActionModePopup != null) {
