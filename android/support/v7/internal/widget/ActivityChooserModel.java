...
public class ActivityChooserModel extends DataSetObservable {
   ...
   private ActivityChooserModel.ActivitySorter mActivitySorter = new ActivityChooserModel.DefaultSorter(null);
      ...
      if(!this.mReadShareHistoryCalled) {
         ...
         if(this.mHistoricalRecordsChanged) {
            ...
            if(!TextUtils.isEmpty(this.mHistoryFileName)) {
               AsyncTaskCompat.executeParallel(new ActivityChooserModel.PersistHistoryAsyncTask(null), new Object[]{this.mHistoricalRecords, this.mHistoryFileName});
               return;
            }
         }
