...
public class MenuDialogHelper implements OnKeyListener, OnClickListener, OnDismissListener, MenuPresenter.Callback {
   ...
   public void show(IBinder var1) {
      ...
      Builder var3 = new Builder(var2.getContext());
