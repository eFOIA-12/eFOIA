...
public class MenuBuilder implements SupportMenu {
   ...
   private boolean dispatchSubMenuSelected(SubMenuBuilder var1, MenuPresenter var2) {
      ...
      if(this.mPresenters.isEmpty()) {
         ...
         Iterator var7 = this.mPresenters.iterator();
         ...
         while(true) {
            ...
            if(var6 == null) {
               ...
               var3 = var6.onSubMenuSelected(var1);
            }
         }
      }
   ...
   MenuItemImpl findItemWithShortcutForKey(int var1, KeyEvent var2) {
      ...
      if(!var8.isEmpty()) {
         ...
         for(int var3 = 0; var3 < var6; ++var3) {
            ...
            if(var4 == var9.meta[0] && (var5 & 2) == 0 || var4 == var9.meta[2] && (var5 & 2) != 0 || var7 && var4 == 8 && var1 == 67) {
               return var10;
            }
         }
      }
   ...
   void findItemsWithShortcutForKey(List var1, int var2, KeyEvent var3) {
      ...
      if(var3.getKeyData(var9) || var2 == 67) {
         ...
         for(int var4 = 0; var4 < var7; ++var4) {
            ...
            if((var6 & 5) == 0 && var5 != 0 && (var5 == var9.meta[0] || var5 == var9.meta[2] || var8 && var5 == 8 && var2 == 67) && var10.isEnabled()) {
               var1.add(var10);
            }
         }
      }
