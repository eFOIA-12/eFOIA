...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
   ...
   public SearchView(Context var1, AttributeSet var2, int var3) {
      ...
      this.mSearchPlate.setBackgroundDrawable(var5.getDrawable(R.styleable.SearchView_queryBackground));
      this.mSubmitArea.setBackgroundDrawable(var5.getDrawable(R.styleable.SearchView_submitBackground));
      this.mSearchButton.setImageDrawable(var5.getDrawable(R.styleable.SearchView_searchIcon));
      this.mGoButton.setImageDrawable(var5.getDrawable(R.styleable.SearchView_goIcon));
      this.mCloseButton.setImageDrawable(var5.getDrawable(R.styleable.SearchView_closeIcon));
      this.mVoiceButton.setImageDrawable(var5.getDrawable(R.styleable.SearchView_voiceIcon));
      this.mCollapsedIcon.setImageDrawable(var5.getDrawable(R.styleable.SearchView_searchIcon));
      ...
      CharSequence var4 = var5.getText(R.styleable.SearchView_queryHint);
      if(!TextUtils.isEmpty(var4)) {
         this.setQueryHint(var4);
      }
   ...
   private void updateQueryHint() {
      if(this.mQueryHint != null) {
         this.mSearchSrcTextView.setHint(this.getDecoratedHint(this.mQueryHint));
      } else {
         if(!IS_AT_LEAST_FROYO || this.mSearchable == null) {
            this.mSearchSrcTextView.setHint(this.getDecoratedHint(""));
            return;
         }
         ...
         if(var2 != null) {
            this.mSearchSrcTextView.setHint(this.getDecoratedHint(var2));
            return;
         }
      }
