...
public class Toolbar extends ViewGroup {
   ...
   public Toolbar(Context var1, @Nullable AttributeSet var2, int var3) {
      super(ViewUtils.themifyContext(var1, var2, false, true), var2, var3);
      ...
      this.mMinHeight = var7.getDimensionPixelSize(R.styleable.Toolbar_android_minHeight, 0);
      var7.recycle();
      this.mTintManager = var7.getTintManager();
   }
   ...
   private void addSystemView(View var1) {
      android.view.ViewGroup.LayoutParams var2 = var1.getLayoutParams();
      Toolbar.LayoutParams var3;
      if(var2 == null) {
         var3 = this.generateDefaultLayoutParams();
      } else if(!this.checkLayoutParams(var2)) {
         var3 = this.generateLayoutParams(var2);
      } else {
         var3 = (Toolbar.LayoutParams)var2;
      }
   ...
   private int getMinimumHeightCompat() {
      return VERSION.SDK_INT >= 16?ViewCompat.getMinimumHeight(this):this.mMinHeight;
   }
   ...
   private void setChildVisibilityForExpandedActionView(boolean var1) {
      int var4 = this.getChildCount();

      for(int var2 = 0; var2 < var4; ++var2) {
         View var5 = this.getChildAt(var2);
         if(((Toolbar.LayoutParams)var5.getLayoutParams()).mViewType != 2 && var5 != this.mMenuView) {
            byte var3;
            if(var1) {
               var3 = 8;
            } else {
   ...
   private void updateChildVisibilityForExpandedActionView(View var1) {
      if(((Toolbar.LayoutParams)var1.getLayoutParams()).mViewType != 2 && var1 != this.mMenuView) {
         byte var2;
   ...
   protected void onLayout(boolean var1, int var2, int var3, int var4, int var5) {
      ...
      var19[1] = 0;
      var19[0] = 0;
      int var11 = this.getMinimumHeightCompat();
      var2 = var10;
      var3 = var5;
   ...
   public void setLogo(int var1) {
      this.setLogo(this.mTintManager.getDrawable(var1));
   }
   ...
   public void setNavigationIcon(int var1) {
      this.setNavigationIcon(this.mTintManager.getDrawable(var1));
   }
