...
public class ShareActionProvider extends ActionProvider {
   ...
   private final ShareActionProvider.ShareMenuItemOnMenuItemClickListener mOnMenuItemClickListener = new ShareActionProvider.ShareMenuItemOnMenuItemClickListener(null);
   ...
   private void setActivityChooserPolicyIfNeeded() {
      if(this.mOnShareTargetSelectedListener != null) {
         if(this.mOnChooseActivityListener == null) {
            this.mOnChooseActivityListener = new ShareActionProvider.ShareActivityChooserModelPolicy(null);
         }
   ...
   public View onCreateActionView() {
      ...
      var1.setExpandActivityOverflowButtonDrawable(TintManager.getDrawable(this.mContext, var2.resourceId));
