...
public class CountryArrayAdapter extends ArrayAdapter {
   ...
   public CountryArrayAdapter(Context var1, int var2, List var3) {
   ...
   public View getDropDownView(int var1, View var2, ViewGroup var3) {
      ...
      var5.setText(((Country)this.mIdMap.get(var1)).getTitle());
      return var2;
   }
   ...
   public View getView(int var1, View var2, ViewGroup var3) {
      var2 = LayoutInflater.from(this.getContext()).inflate(2130968674, var3, false);
      TextView var5 = (TextView)var2.findViewById(2131689856);
      Typeface var4 = Typeface.createFromAsset(this.context.getAssets(), "nexa_light.otf");
      var5.setTextSize(14.0F);
      var5.setTypeface(var4);
      var5.setText(((Country)this.mIdMap.get(var1)).getTitle());
      return var2;
