...
import gov.dhs.mobile.efoia.models.Processing;
import java.util.List;

public class ProcessingArrayAdapter extends ArrayAdapter {
   ...
   public ProcessingArrayAdapter(Context var1, int var2, List var3) {
   ...
   public Processing getItem(int var1) {
      return (Processing)this.mIdMap.get(var1);
   }
   ...
   public View getView(int var1, View var2, ViewGroup var3) {
      ProcessingArrayAdapter.ViewHolder var5;
      if(var2 == null) {
         var2 = LayoutInflater.from(this.getContext()).inflate(2130968661, var3, false);
         var5 = new ProcessingArrayAdapter.ViewHolder();
         var5.position = var1;
         var2.setTag(var5);
      } else {
         var5 = (ProcessingArrayAdapter.ViewHolder)var2.getTag();
      }

      Processing var4 = (Processing)this.mIdMap.get(var1);
      ...
      var5.actText.setText(var4.getProcessingText());
      return var2;
   }
