...
public class SuffixArrayAdapter extends ArrayAdapter {
   private Context context;
   List mIdMap;

   public SuffixArrayAdapter(Context var1, int var2, List var3) {
   ...
   public View getDropDownView(int var1, View var2, ViewGroup var3) {
      ...
      var5.setText(((Suffix)this.mIdMap.get(var1)).getTitle());
      return var2;
   }
   ...
   public View getView(int var1, View var2, ViewGroup var3) {
      ...
      var4.setText(((Suffix)this.mIdMap.get(var1)).getTitle());
      return var2;
   }
