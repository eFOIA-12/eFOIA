...
public class Title extends CRModel implements Parcelable {
   private static final Creator CREATOR = new Creator() {
      public Title createFromParcel(Parcel var1) {
         Title var2 = new Title();
      ...
      public Title[] newArray(int var1) {
         return new Title[var1];
      }
   };
   ...
   public Title(long var1, String var3, String var4, CRImage var5) {
